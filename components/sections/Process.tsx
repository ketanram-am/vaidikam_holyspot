...
export default function Process() {
  return (
    <Section tone="ivory" labelledBy="process-title">
      <SectionHeader
        id="process-title"
      ...
      <ol className="mt-headline grid gap-x-0 gap-y-0 border-y border-bronze/25 sm:grid-cols-2 sm:gap-y-12 lg:grid-cols-4">
        {process.map((p, i) => (
          <Reveal
            as="li"
            key={p.step}
            index={i}
            className={`relative grid grid-cols-[3.5rem_minmax(0,1fr)] gap-x-4 border-b border-bronze/20 px-0 py-8 last:border-b-0 sm:block sm:border-b-0 sm:px-6 sm:py-10 lg:border-l lg:border-bronze/20 ${
